...
<form action="./EntryArticleServlet" method="post">
    <p><label>タイトル：</label><br>
        <input type="text" name="title" size="40" maxlength="30" placeholder="タイトルを入力してください．"></p>
    <p><label>本文：</label><br>
        <textarea name="body" rows="5" cols="40" placeholder="本文を入力してください．"></textarea></p>
    <!-- 限定公開フラグのチェックボックスを追加 -->
    <p><label>限定公開：</label>
        <input type="checkbox" name="isPrivate" value="true"> この投稿を限定公開にする</p>
